...
// #include <fstream>
// // 1. fstreambase
// // 2. ifstream --> derive from fstreambase
// // 3. ofstream --> derive from fstreambase
// using namespace std;
// int main(void) {
//     string st ;

//     // ofstream out("sample.txt"); // Creates a file named "sample.txt" for writing
//     // out << st; 
//     ifstream in("sample.txt"); // Creates a file named "sample.txt" for writing
//     in>>st;       
//     cout<<st<<endl;          // Writes the string "Harry bhai" into the file
//     in.close();                // Closes the output file stream
//     return 0;
// }
